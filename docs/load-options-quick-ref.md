...
└─ Higher interaction → "-interactLevel BEST_DATA"
...
- [Chinese Guide](copilot/load-options-guide-zh.md)
- [Source Code](../submodules/Browser4/browser4-core/browser4-skeleton/src/main/kotlin/ai/platon/pulsar/skeleton/common/options/LoadOptions.kt)
