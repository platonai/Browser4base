 ...
 * */
val Document.normalizedURI: String?
    get() {
        if (isNil) {
            return NILBaseUri
        }
 ...
 * */
var Document.primaryGrid by field { DimI(0, 0) }

/**
 * The secondary grid of the document.
 * */
var Document.secondaryGrid by field { DimI(0, 0) }

/**
 * The grid of the document.
 * */
var Document.grid by field { DimI(0, 0) }
 ...
 * */
val Node.dimension get() = DimI(width, height)
