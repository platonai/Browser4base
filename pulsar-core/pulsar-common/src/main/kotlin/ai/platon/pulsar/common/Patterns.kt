...
object Patterns {
     ...
     * @hide
     */
    val IANA_TOP_LEVEL_DOMAINS: String = ("(?:"
    ...
    const val GOOD_IRI_CHAR: String = "a-zA-Z0-9\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF"
     ...
     */
    val PHONE
            : Pattern = Pattern.compile( // sdd = space, dot, or dash
        ("(\\+[0-9]+[\\- \\.]*)?" // +<digits><sdd>*
                + "(\\([0-9]+\\)[\\- \\.]*)?" // (<digits>)<sdd>*
                + "([0-9][0-9\\- \\.]+[0-9])")
    ...
    fun digitsAndPlusOnly(matcher: Matcher): String {
        ...
        while (i < size) {
            val character = matchingRegion.get(i)
