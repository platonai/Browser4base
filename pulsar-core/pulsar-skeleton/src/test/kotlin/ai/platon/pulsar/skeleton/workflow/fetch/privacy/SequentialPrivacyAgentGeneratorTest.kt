...
class SequentialBrowserProfileGeneratorTest {
    ...
    fun setUp() {
        conf = MutableConfig()
        generator = SequentialBrowserProfileGenerator("test-skeleton-privacy")
        mockFingerprint = Fingerprint.EXAMPLE
        contextBaseDir = AppPaths.getContextBaseDir("test-skeleton-privacy", mockFingerprint.browserType)
