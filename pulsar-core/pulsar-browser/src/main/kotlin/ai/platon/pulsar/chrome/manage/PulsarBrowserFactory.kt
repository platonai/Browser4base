...
class PulsarBrowserFactory(
    ...
    override fun launchSystemDefaultBrowser(): Browser =
        launcher.launch(BrowserId.createSystemDefault(), LauncherOptions(settings), ChromeOptions())
    ...
    override fun launchDefaultBrowser(): Browser =
        launcher.launch(BrowserId.createDefault(), LauncherOptions(settings), ChromeOptions())
    ...
    override fun launchPrototypeBrowser(): Browser =
        launcher.launch(BrowserId.createPrototype(), LauncherOptions(settings), ChromeOptions())
    ...
    override fun launchNextSequentialBrowser(): Browser =
        launcher.launch(BrowserId.createNextSequential(), LauncherOptions(settings), ChromeOptions())
    ...
    override fun launchRandomTempBrowser(): Browser =
        launcher.launch(BrowserId.createRandomTemp(), LauncherOptions(settings), ChromeOptions())
}
