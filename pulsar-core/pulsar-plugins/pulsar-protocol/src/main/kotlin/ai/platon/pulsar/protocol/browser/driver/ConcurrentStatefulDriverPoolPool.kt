...
class ConcurrentStatefulDriverPoolPool {
    ...
    fun subscribeDriver(browserId: BrowserId): WebDriver? {
        if (browserId.profile.isPermanent) {
            throw IllegalStateException("Permanent browser should only be used not be used in a pool | browserId: $browserId")
        }
     ...
     * for example, privacy contexts generated by SequentialBrowserProfileGenerator.
     * */
